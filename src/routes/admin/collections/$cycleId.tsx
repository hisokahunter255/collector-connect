...
function CycleDetailsPage() {
  ...
  return <div className="space-y-6">
    ...
    {cycle.status === "open" ? <section className="card-elevated p-4"><div className="mb-4"><h2 className="font-bold">إضافة عملية تحصيل</h2><p className="text-xs text-muted-foreground">يمكن تسجيل التحصيل على دفعات طوال فترة الدورة</p></div>
